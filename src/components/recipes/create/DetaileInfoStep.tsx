...
type DetailedInfoStepProps = {
    form: UseFormReturn<z.infer<typeof FormSchema> & { ingedientsStr: string; stepsString: string }>,
...
export default function DetailedInfoStep({ form, buttonAddIngredient, buttonAddStep, handleAddStep, handleAddIngredient }: DetailedInfoStepProps) {
    return (
        <>
            <FormField
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <div className="flex flex-col">
                                ...
                                <ChipComponent values={form.getValues().ingredients} onDelete={(_, index) => {
                                    const ingredients =
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <div className="flex flex-col">
                                ...
                                <ChipComponent values={form.getValues().steps} onDelete={(_, index) => {
